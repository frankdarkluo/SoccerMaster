...
class KalmanFilter(object):
    """
    A simple Kalman filter for tracking players in pitch coordinates.

    The 4-dimensional state space

        x, y, vx, vy

    contains the pitch position (x, y) and their respective velocities.

    Object motion follows a constant velocity model. The position
    ...
    def initiate(self, measurement):
        ...
        ----------
        measurement : ndarray
            Position coordinates (x, y) on the pitch.
