...
def main() -> None:
    ...
    from pipeline.stage2.digest import build_tracking_digest
    from pipeline.stage2.generate_direct import ark_model, generate_direct
    from pipeline.stage2.video import build_clip_mp4, video_duration_s
